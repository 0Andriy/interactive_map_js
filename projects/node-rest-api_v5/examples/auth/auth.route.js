...
router.post(
    '/signup',
    validateSchema({ body: authSchemas.registerSchema }),
...
router.post(
    '/login',
    validateSchema({ body: authSchemas.loginSchema }),
...
router.get('/refresh-token', authControler.refreshTokensFromCookieController)
...
router.post(
    '/forgot-password',
    validateSchema({ body: authSchemas.forgotPasswordSchema }),
...
router.post('/verify-token', authControler.verifyTokenFromBodyController)
