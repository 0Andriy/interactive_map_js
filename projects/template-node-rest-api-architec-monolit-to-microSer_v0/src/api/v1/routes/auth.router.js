...
router.post('/signup', validateSchema({ body: authSchema.registerSchema }), authController.register)
...
router.post('/login', validateSchema({ body: authSchema.loginSchema }), authController.login)
