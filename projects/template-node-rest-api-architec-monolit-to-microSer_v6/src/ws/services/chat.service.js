...
const handleChatClose = async (ws) => {
    ...
    // // Отримуємо список кімнат, в яких перебував клієнт
    // const clientRooms = Array.from(roomManager.getClientRooms(ws.id) || [])

    // for (const roomName of clientRooms) {
    //     // Якщо кімната була чатовою, оповістити інших (RoomManager вже видалив клієнта з кімнати)
