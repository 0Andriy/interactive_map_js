...
import { loggingUserResolver } from './middlewares/loggingUserResolver.js'
import { requestContextMiddleware } from './middlewares/requestContext.js'
import morganMiddleware from './middlewares/morganMiddleware.js'
import dbNameResolver from './middlewares/dbNameResolver.js'
...
export async function createExpressApp({ wsAppInstance = null } = {}) {
    ...
    app.use((req, res, next) => {
        ...
        const shouldIgnore = ignoredPaths.some(
