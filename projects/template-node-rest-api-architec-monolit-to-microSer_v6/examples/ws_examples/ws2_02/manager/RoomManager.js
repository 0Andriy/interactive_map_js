 ...
 * Використовує Redis Pub/Sub для крос-процесної комунікації між інстансами сервера.
 */

import WebSocket from 'ws'
import crypto from 'crypto' // або import { v4 as uuidv4 } from 'uuid';
...
class RoomsManager {
    ...
    joinRoom(
        ...
        // Додаємо клієнту унікальний id якщо нема
