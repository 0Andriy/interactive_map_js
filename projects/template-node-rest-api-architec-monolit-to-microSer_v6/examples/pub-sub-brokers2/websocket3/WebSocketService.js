...
class WebSocketService {
    constructor(httpServer, eventBroker, logger) {
        ...
        this.eventBroker.subscribe('ws:intercom', this.handleBrokerMessage.bind(this))
    ...
    handleClose(connectionId) {
        ...
        if (connection) {
            // Видаляємо клієнта з усіх його локальних кімнат при відключенні
            this.namespaces.forEach((ns) => ns.leaveRoom(connection))
