 ...
 */
export const create = async (dbName, userData) => {
    logger.debug(
 ...
 */
export const findById = async (dbName, userId, includeDeleted = false) => {
 ...
 * @returns {Promise<object|null>} Об'єкт користувача або null.
 */
export const findByUsername = async (dbName, username, includeDeleted = false) => {
 ...
 * @returns {Promise<object|null>} Об'єкт користувача або null.
 */
export const findByEmail = async (dbName, email, includeDeleted = false) => {
 ...
 */
export const update = async (dbName, userId, updates) => {
 ...
 */
export const verifyPassword = async (dbName, userId, password) => {
