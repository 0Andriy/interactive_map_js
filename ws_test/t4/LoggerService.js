export class LoggerService {
  ...
  debug(msg, ctx) { this.#log('debug', '\x1b[35m', msg, ctx); } // Фіолетовий
  info(msg, ctx)  { this.#log('info', '\x1b[32m', msg, ctx); }  // Зелений
  warn(msg, ctx)  { this.#log('warn', '\x1b[33m', msg, ctx); }  // Жовтий
  error(msg, ctx) { this.#log('error', '\x1b[31m', msg, ctx); } // Червоний
}
